...
library NFTDescriptor {
    ...
    function constructTokenURI(ConstructTokenURIParams memory params) public pure returns (bytes memory) {
        ...
        return abi.encodePacked('data:application/json;base64,', bytes(Base64.encode(abi.encodePacked(
            '{"LSP4Metadata":{',
                '"name":"', name,'",',
                ...
                '"images":[[',
                    '{',
                        '"width":200,',
                        '"height":200,',
                        '"url":"', 'data:image/svg+xml;base64,',Base64.encode(bytes(generateSVGImage(params))) ,'",',
                        '"verification":{',
                            '"method":"0x00000000",',
                            '"data":"0x"',
                        '}',
